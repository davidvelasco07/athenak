#!/usr/bin/env python3
"""Mosaic of the 128^3 PPM+FB UCT mood_rtol sweep at t=1.5
(RK3, HLLD, uct_hlld, mood_nad_b=comps, mood_nad_v=comps, revs=2)."""
...
CASES = [
    ...
    ("uct_bcomps_vcomps", "rtol=1e-5 (default)", "00006"),
    ("uct_rtol6", "rtol=1e-6", "00006"),
    ("uct_rtol7", "rtol=1e-7", "00006"),
]
SLICES = [
...
def main():
    ...
    fig.suptitle(
        "PPM+FB UCT mood_rtol sweep (b,v=comps, revs=2) at t = 1.5 (RK3, HLLD, 128$^3$)",
        fontsize=15,
    )
    out_png = os.path.join(RUNROOT, "mosaic_uct_rtol_t1p5.png")
