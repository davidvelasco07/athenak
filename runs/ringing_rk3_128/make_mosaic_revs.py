#!/usr/bin/env python3
"""Mosaic of the 128^3 PPM+FB UCT mood_max_revs sweep at t=1.5
(RK3, HLLD, uct_hlld, mood_nad_b=comps, mood_nad_v=comps)."""
...
CASES = [
    ...
    ("uct_revs1", "revs=1\n(CRASHED t=1.45; shown t=1.25)", "00005"),
    ("uct_bcomps_vcomps", "revs=2 (default)", "00006"),
    ("uct_revs3", "revs=3", "00006"),
    ("uct_revs4", "revs=4", "00006"),
]
SLICES = [
...
def main():
    ...
    fig.suptitle(
        "PPM+FB UCT mood_max_revs sweep (b,v=comps) at t = 1.5 (RK3, HLLD, 128$^3$)",
        fontsize=15,
    )
    out_png = os.path.join(RUNROOT, "mosaic_uct_revs_t1p5.png")
