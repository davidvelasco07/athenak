#!/usr/bin/env python3
"""Mosaic of the 128^3 PPM+FB NAD detector variants vs PLM at t=1.5 (RK3, HLLD)."""
...
CASES = [
    ...
    ("bcomps", "PPM+FB nad_b=comps"),
    ("bvcomps", "PPM+FB nad_b+v=comps"),
]
SLICES = [
...
def main():
    ...
    fig.suptitle(
        "PPM+FB NAD detector variants at t = 1.5 (RK3, HLLD, 128$^3$)",
        fontsize=15,
    )
    out_png = os.path.join(RUNROOT, "mosaic_detector_t1p5.png")
