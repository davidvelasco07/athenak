...
// ppm = unlimited 4th-order face interpolation (requires mood=true for stability
// since the shared face value provides no upwind dissipation)
enum ReconstructionMethod {dc, plm, ppm4, ppmx, wenoz, teno, ppm};
