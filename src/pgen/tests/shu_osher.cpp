...
//========================================================================================
//! \file shu_osher.cpp
//! \brief Built-in Shu–Osher shock–sine interaction (ported from fluids/shu_osher.cpp).
...
void ProblemGenerator::ShuOsher(ParameterInput *pin, const bool restart) {
  if (restart) return;
  ...
  par_for("pgen_shu_osher", DevExeSpace(),0,(pmbp->nmb_thispack-1),ks,ke,js,je,is,ie,
